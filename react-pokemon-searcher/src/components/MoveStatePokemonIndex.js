...
import MoveStatePokemonForm from './MoveStatePokemonForm'
const initialState = {
  name: '',
  hp: '',
  frontUrl: '',
...
class MoveStatePokemonIndex extends React.Component {
  state = {
    pokemon: [],
    searchTerm: '',
    name: '',
...
export default MoveStatePokemonIndex
