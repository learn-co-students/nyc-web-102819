...
### Where do you start?
- Asking questions: Can your repeat numbers? No you can only use each number once? 
- Any patterns to the numbers? 
- ** Clarify, edge cases, the works.
- Handling additions and subtractions
