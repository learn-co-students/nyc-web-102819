...
def num_points_scored(player_name)
  # √construct an array of all players => an array of hashes
  # √find the correct player hash based on the name passed in
  # √lookup the points value in that hash
  # √should return an integer (their points)
