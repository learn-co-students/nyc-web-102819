...
### From the [Rails Docs](https://guides.rubyonrails.org/security.html#sessions) or these [Rails Docs](https://guides.rubyonrails.org/action_controller_overview.html#session):
...
- [More Rails Docs on Sessions](https://guides.rubyonrails.org/action_controller_overview.html#session)
