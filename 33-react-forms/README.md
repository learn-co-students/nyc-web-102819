...
## features
X load all cats from our json-server
X be able to load a single cat from our json-server 
- post a new message to a single cat
- use the filter to view all, matches, or favorites 
